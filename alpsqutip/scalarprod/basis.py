...
def append_basis(basis_1: OperatorBasis, basis_2: OperatorBasis | Iterable[Operator]):
    ...
    basis_1_gen_matrix = basis_1.gen_matrix if basis_1_generator else None
    basis_1_errors = basis_1.errors if basis_1_generator else None
    if isinstance(basis_2, OperatorBasis):
        ...
        basis_2_gen_matrix = basis_2.gen_matrix if basis_2_generator else None
        basis_2_errors = basis_2.errors if basis_2_generator else None
    else:
        ops2 = tuple(basis_2)
